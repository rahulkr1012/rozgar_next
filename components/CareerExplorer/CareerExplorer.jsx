...
import bannerpic from 'src/assets/images/careerExplorerBanner.png';
...
// import { getCollegeList } from 'src/action/CandidateAction';
// import Pagination from 'react-js-pagination'
import collegeImage from 'src/assets/images/collegeImage.jpeg'
...
const images = [
    `${process.env.NEXT_PUBLIC_BASE_URL}/college/logo/1665644639116.jpg`,
    studentBanner,
];
...
export default class StudentsExplorer extends Component {
    ...
    handlePageChange = (pageNumber) => {
        ...
        this.props.getCollegeLists(pageNumber)
        // window.scrollTo(0, 0)
    }
    ...
    searchList = () => {
        this.props.getCollegeLists(this.state.pageNumber)
    }
    ...
    render() {
        const {dataList, showShimmer} = this.props
        const { ShowApplyNowPopUp, showData, firstName, lastName, mobile, email, course, city, open, photoIndex } = this.state
                ...
                <main id="rg-main" className="rg-main rg-haslayout pt-0">
                    <section className='studetsexplorer  -type-5' style={{
                        ...
                        <div className='container'>
                            <div className='row items-center'>
                                <div className='col-lg-4 text-center'><Image className='col-banerimg' src={bannerpic} width={50} height={30}/>
                                </div>
                    ...
                    <section>
                        <div className='container-fluid'>
                            ...
                            <div className='row'>
                                <div className='col-md-12 text-center'>
                                    <Link  href="https://www.mounttalent.com/"  >
                                         <Image className='img-responsiveadd' src={addbanner} width={50} height={30}/>
                                         </Link>
                                                            ...
                                                            <div className='collegeimg'>
                                                                <div className='h-100'>
                                                                    <div className='imgarea'>
                                                                        <Image className='imgmain' src={!item.ENTITY_MAIN_IMAGE ? collegeImage : (`${process.env.NEXT_PUBLIC_BASE_URL}/college/logo/${item.ENTITY_MAIN_IMAGE}`)} width={70} height={50} />
                                                                        <div className='img-overlay'></div>
                                                                        <div className='justify-content-between'>
                                                                            <div className='d-flex'>
                                                                                <Link href="#"  onClick={() => this.setState({ open: true })} className='data-icon'><i class="fa fa-picture-o"></i> 2</Link>
                                                                ...
                                                                <div className='jsx-college college-info d-flex flex-column h-100'>
                                                                    <div className=''>
                                                                            ...
                                                                            <div className='listing-block-clg-info flex-fill'>
                                                                                <div className='bottom-block w-100 position-relative'>
                                                                                    <div className='clg-head d-flex align-items-start mb-2'>
                                                                                        <Link href={`${constant.component.CareerExplorerDetail.url.replace(':url', item.ENTITY_ALIAS)}`} onClick={this.topscroll} className='clg-logo'>
                                                                                            <Image className='col-logo' src={!item.ENTITY_LOGO ? collegeIcon : (` ${process.env.NEXT_PUBLIC_BASE_URL}/college/logo/${item.ENTITY_LOGO}`)} width={70} height={50} />
                                                                                        </Link>
                                                                                        <div className='clg-name-address' style={{ textTransform: 'uppercase', width: '100%' }}>
                                                                                            <Link  href={`${constant.component.CareerExplorerDetail.url.replace(':url', item.ENTITY_ALIAS)}`}>{item.ENTITY_NAME}, <span style={{ textTransform: "uppercase" }}>{item.STATE_NAME}</span></Link>
                                                                        ...
                                                                        <div className='coladdfee w-100 d-flex align-items-center pt-3'>
                                                                            <Link href={`${constant.component.CareerExplorerDetail.url.replace(':url', item.ENTITY_ALIAS)}`} passHref ><i class="lnr lnr-graduation-hat font-16"></i>{item.ENTITYTYPE_NAME ? `${item.ENTITYTYPE_NAME.slice(0, 1)}${item.ENTITYTYPE_NAME.slice(1, item.ENTITYTYPE_NAME.length).toLowerCase()}` : null}</Link>
                                                                            <Link href={`${constant.component.CareerExplorerDetail.url.replace(':url', item.ENTITY_ALIAS)}`} passHref ><i class="lnr lnr-map-marker"></i> {item.STATE_NAME}</Link>
                                                                            <Link href={`${constant.component.CareerExplorerDetail.url.replace(':url', item.ENTITY_ALIAS)}`} passHref ><i class="lnr lnr-briefcase"></i> Courses & Fees</Link>
                            ...
                            {dataList.length == 0 && showShimmer == false && <div className="rg-featurejob text-danger pt-20" style={{ textAlign: 'center' }}>
                                <Image src={noRecordImg}  width={60} height={60}/>
                                <h4>We could not find colleges matching your search criteria.</h4>
                                <h6>Did you enter wrong spelling of any word?</h6>
                                <Link href={`${constant.component.StudentsExplorer.url}`} onClick={this.handleMorColleges} class="rg-btn rg-active btn-primary mb-20" id="showtoast"><span className='text-white'>Browse More Colleges</span></Link>
                            </div>}
                            <div className='row'>
                                <div className='col-md-12'>
                                    ...
                                    <div class="form-group logotextbg">
                                        ...
                                        <div className='d-flex pb-2'>
                                            <div className='Unlogo'>
                                                <Image className='col-logo' src={collegeIcon} width={60} height={60} />
                                            </div>
