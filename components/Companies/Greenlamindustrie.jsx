...
import cafeteriaIcon from '../../src/assets/images/author/cafeteria-icon.png'
import jobsTra1ningIcon from '../../src/assets/images/author/job-training-g.png'
import freefood from '../../src/assets/images/author/free-food.png'

import transporticon from '../../src/assets/images/author/team-outings.png'
...
import pic04 from '../../src/assets/images/Greenlam/pics04.jpg'
import pic03 from '../../src/assets/images/Greenlam/pics03.jpg'
import pic02 from '../../src/assets/images/Greenlam/pics02.jpg'
import pic01 from '../../src/assets/images/Greenlam/pics01.jpg'
import { ToSeoUrl } from 'utils';
import Parser from 'html-react-parser';
import Image from 'next/image';

export default class Greenlamindustrie extends Component {
    constructor(props) {
        super(props);
        this.state = {
                            ...
                            <div className="col md 12">
                                <div className='d-flex justify-content-between'>
                                    <ul className='swiggynav'>
                                        <li><Link href={constant.component.Greenlamindustries.url} className='active'>Home</Link></li>
                                                ...
                                                <Slider {...featuredsettings}>
                                                        ...
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15">
                                                                <div className="rg-companycontent text-center">
                                                                    <Image className='swiggy-facility-icon' src={cafeteriaIcon} />
                                                    ...
                                                    <React.Fragment>
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15">
                                                                <div className="rg-companycontent text-center">
                                                                    <Image className='swiggy-facility-icon' src={jobsTra1ningIcon} />
                                                                    <div className="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <React.Fragment>
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15">
                                                                <div className="rg-companycontent text-center">
                                                                    <Image className='swiggy-facility-icon' src={freefood} />
                                                                    <div className="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <React.Fragment>
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15">
                                                                <div className="rg-companycontent text-center">
                                                                    <Image className='swiggy-facility-icon' src={transporticon} />
                                                                    <div className="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <React.Fragment>
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15">
                                                                <div className="rg-companycontent text-center">
                                                                    <Image className='swiggy-facility-icon' src={transporticonFree} />
                                                                    <div className="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <React.Fragment>
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15">
                                                                <div className="rg-companycontent text-center">
                                                                    <Image className='swiggy-facility-icon' src={childCare} />
                                                                    <div className="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <React.Fragment>
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15">
                                                                <div className="rg-companycontent text-center">
                                                                    <Image className='swiggy-facility-icon' src={workFromHome} />
                                                                    <div className="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <React.Fragment>
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15">
                                                                <div className="rg-companycontent text-center">
                                                                    <Image className='swiggy-facility-icon' src={educationAssistance} />
                                                                    <div className="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <React.Fragment>
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15">
                                                                <div className="rg-companycontent text-center">
                                                                    <Image className='swiggy-facility-icon' src={gymnasium} />
                                                                    <div className="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <React.Fragment>
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15">
                                                                <div className="rg-companycontent text-center">
                                                                    <Image className='swiggy-facility-icon' src={cafeteriaFIcon} />
                                                                    <div className="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <React.Fragment>
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15">
                                                                <div className="rg-companycontent text-center">
                                                                    <Image className='swiggy-facility-icon' src={foodFreeIcon} />
                                                                    <div className="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <React.Fragment>
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15">
                                                                <div className="rg-companycontent text-center">
                                                                    <Image className='swiggy-facility-icon' src={relocation} />
                                                                    <div className="d-flex justify-content-center align-items-center">
                                                ...
                                                <Slider {...featuredsettings}>
                                                        ...
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15 p-0">
                                                                <div className="rg-companycontent text-center p-0">
                                                                    <Image className='swiggy-facility-icon' src={pic04} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </React.Fragment>
                                                    <React.Fragment>
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15 p-0">
                                                                <div className="rg-companycontent text-center p-0">
                                                                    <Image className='swiggy-facility-icon' src={pic03} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </React.Fragment>
                                                    <React.Fragment>
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15 p-0">
                                                                <div className="rg-companycontent text-center p-0">
                                                                    <Image className='swiggy-facility-icon' src={pic02} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </React.Fragment>
                                                    <React.Fragment>
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15 p-0">
                                                                <div className="rg-companycontent text-center p-0">
                                                                    <Image className='swiggy-facility-icon' src={pic01} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </React.Fragment>
                                                                    ...
                                                                    <div class="rg-featurejob">
                                                                        <div class="rg-companycontent">
                                                                            <figure class="roz-companydetaillogo">
                                                                                <a href="#">
                                                                                    {item.COMPANY_LOGO === 'NA' ? <h3>{nameInitial}</h3> : <a href={dynamicURL} target='_blank'><img src={`${process.env.NEXT_PUBLIC_BASE_URL}/company/logo/${item.COMPANY_LOGO}`} alt="image description" /></a>}
                                                                                </a>
                                                                            </figure>
