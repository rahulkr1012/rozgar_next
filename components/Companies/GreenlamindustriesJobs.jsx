...
export default class GreenlamindustriesJobs extends Component {
    constructor(props) {
        super(props);
        this.state = {
                            ...
                            <div className="col md 12">
                                <div className='d-flex justify-content-between'>
                                    <ul className='swiggynav'>
                                        ...
                                        <li><Link href={constant.component.GreenlamindustriesJobs.url} className='active'>Jobs</Link></li>
                                ...
                                <div id="rg-twocolumns" className="rg-twocolumns">
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-9 float-left">
                                        ...
                                        <div className="swiggy-tech-stack">
                                            <div className="swiggy-tech-stack-head">Greenlam Industries's Tech Stack</div>
                                        ...
                                        <aside id="rg-sidebarvtwo" className="rg-sidebar rg-sidebarvtwo">
                                            <div className="swiggy-apply-jobbox">
                                                <div className="swiggy-text-logo">
                                                    <h3>Want to work at Greenlam Industries jos?</h3>
