...
export default withRouter(class Swiggys extends Component {
    constructor(props) {
        super(props);
        this.state = {
                            ...
                            <div className="col md 12">
                                <div className='d-flex justify-content-between'>
                                    <ul className='swiggynav'>
                                        <li><Link href={constant.component.Swiggy.url} className='active'>Home</Link></li>
                                                        ...
                                                        <div className='col-md-12 mob-pad-0'>
                                                            <div className="rg-featurejob job-slice mb-15">
                                                                <div className="rg-companycontent text-center">
                                                                    <Image className='swiggy-facility-icon'
                                                                        width={1000}
                                                                        height={1000}
                                                                        src={cafeteriaIcon} />
                                                            ...
                                                            <div className="rg-featurejob job-slice mb-15">
                                                                <div className="rg-companycontent text-center">
                                                                    <Image
                                                                        width={1000}
                                                                        height={1000}
                                                                        className='swiggy-facility-icon' src={educationAssistance} />
                                                                    <div className="d-flex justify-content-center align-items-center">
                                                            ...
                                                            <div className="rg-featurejob job-slice mb-15 p-0">
                                                                <div className="rg-companycontent text-center p-0">
                                                                    <Image
                                                                        width={1000}
                                                                        height={1000}
                                                                        className='swiggy-facility-icon' src={pic04} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </React.Fragment>
                                                            ...
                                                            <div className="rg-featurejob job-slice mb-15 p-0">
                                                                <div className="rg-companycontent text-center p-0">
                                                                    <Image
                                                                        width={1000}
                                                                        height={1000}
                                                                        className='swiggy-facility-icon' src={pic03} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </React.Fragment>
                                                            ...
                                                            <div className="rg-featurejob job-slice mb-15 p-0">
                                                                <div className="rg-companycontent text-center p-0">
                                                                    <Image
                                                                        width={1000}
                                                                        height={1000}
                                                                        className='swiggy-facility-icon' src={pic02} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </React.Fragment>
                                                            ...
                                                            <div className="rg-featurejob job-slice mb-15 p-0">
                                                                <div className="rg-companycontent text-center p-0">
                                                                    <Image
                                                                        width={1000}
                                                                        height={1000}
                                                                        className='swiggy-facility-icon' src={pic01} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </React.Fragment>
                                            ...
                                            <div className="swiggy-boxshow pt-2">
                                                <div className="row">
                                                    ...
                                                    <div class="view-all-openings pb-1 text-right">
                                                        <Link href={constant.component.SwiggyJobs.url}>View All Openings</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
