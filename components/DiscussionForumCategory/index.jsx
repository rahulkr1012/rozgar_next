...
export default class DiscussionForum extends Component {
    constructor(props){
       ...
       this.state = {
            openModal: false,
            onKeywordChange: this.props.router.query ? this.props.router.query .searchThreat : "",
            loader: undefined,
            path: undefined,
    ...
    categoryWiseFilter = (DISCUSSION_CATEGORY_ID, DISCUSSION_CATEGORY_TITLE) => {
        this.props.router.push({
            ...
            query: { DISCUSSION_CATEGORY_ID: DISCUSSION_CATEGORY_ID, DISCUSSION_CATEGORY_TITLE: DISCUSSION_CATEGORY_TITLE }
        })
        // as={`/category/${i.URL}`}
    }
    onSearchQuestions = () => {
    ...
    render() {
        ...
        const Category = d1[1]
        if (this.props.router.query !== this.state.path) {
                                                ...
                                                <div className='answer-action shadow'>
                                                    <div className='action-content'>
                                                        <div className='image-wrap'>
                                                            <img src={answerImage} alt='answer action' />
                                                        </div>
                                                            ...
                                                            <div className='tt-col-avatar'>
                                                                <React.Fragment className='tt-icon'>
                                                                    ...
                                                                    {i.PROFILE_IMAGE ?
                                                                        ...
                                                                        <img src={Picss} style={{ borderRadius: '25px' }} />}
                                                                </React.Fragment>
                                                            </div>
