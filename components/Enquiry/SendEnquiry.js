...
import { inquiryForm } from '@/actions/jobsByAction'
...
export default class SendEnquiry extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            whatsapp: { name: "whatsapp", error: "", value: true , isRequired: false }
           }
    ...
    handleSubmit(event) {
        ...
        const { name, email, number, discription  ,whatsapp} = this.state
        ...
        let model = {
            ...
            WHATSAPP_ALERT:whatsapp.value?'true':'false'
        }
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="inner-enquiry-form-area">
                                            ...
                                            <div className="enquiry-input-box">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <NumericFormat
                                                        ...
                                                        className={number.error.length > 0
                                                            ? "form-control is-invalid"
                                        ...
                                        <div className=  {this.state.whatsapp.value?"sendmeimfo":"sendmeimfouncheck" } >
                                        <input
                                         name={this.state.whatsapp.name}
                                         onChange={(e)=>{
                                         this.setState({
                                            ...this.state , [e.target.name]:{...this.state.whatsapp,
                                             value:!this.state.whatsapp.value} 
                                             })
                                        }}
                                        value={this.state.whatsapp.value}
                                         type="checkbox" />
