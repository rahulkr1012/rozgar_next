...
import LoaderList from 'components/common/GovtLoader/LoaderList'
...
class index extends Component {
  ...
  render() {
    ...
    const joburl = capFirstLetterInSentence(this.props.router.query.url.replace(/-/g, ' '))
                  ...
                  <div className='col-md-12'>
                    <div className='breadcrumbs-bx'>
                      ...
                      <p d="breadcrumbs"> <span><span><a href={'/'}>Home</a>   /
                        ...
                        <strong style={{ color: "#e81c28", fontWeight: '500' }} className="breadcrumb_last"> {joburl}  </strong>
              ...
              <div className="container">
                <div className="row">
                  ...
                  <div className="col-12 col-sm-12 col-md-8 col-lg-8">
                      {this.props.showLoader?<LoaderList/>:
                    <div className="brows-by-locations-gob-bx">
                      ...
                      <div className="by-locations-head">
                        {JobList && JobList.map((item, index) => {
                          if (index == 0) {
                            return (
                              <h2 style={{ fontSize: '15px', fontWeight: 'bold' }} className="small_title">Browse {item.STATE == null ? "Central" : item.STATE} Government Jobs</h2>
                              ...
                              <div className="rg-featurejob">
                                ...
                                <div className="rg-companycontent">
                                  ...
                                  <div className="rg-companyname rg-gov-depart-name">
                                    ...
                                    {item.CATEGORY == "CENTRAL" ? "" : <h6><a target="_blank" href="">{item.LOCATION == null ? item.STATE : item.STATE == null ? item.LOCATION : item.STATE == null && item.LOCATION == null ? "" : (item.LOCATION, item.STATE)}</a></h6>}
                  ...
                  <div className='col-md-4'>
                    <div className="savejobs-aside gov-jobs-aside">
                      {JobList.length > 0 ? JobList && JobList.map((item, index) => {
                        if (index == 0) {
                          return (
                        ...
                        {this.props.DeptshowLoader?<Loader/>:
                      <ul>
