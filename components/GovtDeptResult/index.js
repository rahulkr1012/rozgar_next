...
import pic05 from 'src/assets/images/newicon.gif'
...
class index extends Component {
  ...
  render() {
    ...
    const ResultLists = this.props.joblist
    ...
    return (
      <React.Fragment>
                ...
                <div className="row">
                  <div className="col-md-12">
                   {ResultList&&ResultList.length>0?ResultList.map((item,index)=>{
                           ...
                           }):<h4>Latest {capFirstLetterInSentence(this.props.router.query.state.replaceAll('-',' '))} Government Jobs Result</h4>}
                  </div>
                </div>
              </div>
            </div>
        <div className='breadcrumbs-section'>
             ...
             <div className='row'>
                 <div className='col-md-12'>
                      <div className='breadcrumbs-bx'>
                              ...
                              <a href={constant.component.GovernmentResult.url.replace(':url'  , state =="central"?"central-government-result" :state)}> {capFirstLetterInSentence(state)}</a> /
                              <a href=""> Department</a> /
          ...
          <div className="rozgar-browseJobs government-result-section">
              <div className="container">
                <div className="row">
                        ...
                        <div className='latest-government-result'>
                          ...
                          <ul className='latest-government-result-list'>
                            ...
                            <h5>{item.DEPARTMENT}</h5>
                              ...
                              <span className='result-date'>{moment(item.CREATED_ON).format('DD MMM, YYYY')}</span><span className='result-see-btn'><a target='blank' href={item.RESULT_URL.split("//")[0]=="https:"?item.RESULT_URL:"https://" + item.RESULT_URL}>View Result</a></span></li>
                      ...
                      <ul>
                        {DeptList&&DeptList.length>0?DeptList.map((item)=>{
                          ...
                          return(
                            ...
                            <div className='visit-site'><a target='_blank' href={ item.DEPARTMENT_WEBSITE.split("//")[0]=='https:'?item.DEPARTMENT_WEBSITE:"https://"+item.DEPARTMENT_WEBSITE}>Visit official website <i class="fa fa-external-link" aria-hidden="true"></i></a></div>
                          ...
                          return(
                            ...
                            <div className='visit-site'>
                              <a target='_blank' href={item.DEPARTMENT_WEBSITE.split("//")[0]=='https:'?item.DEPARTMENT_WEBSITE:"https://"+item.DEPARTMENT_WEBSITE}>Visit official website <i class="fa fa-external-link" aria-hidden="true"></i></a>
                              </div>
