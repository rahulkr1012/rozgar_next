...
import {  answerById ,addInterviewQuestionAnswer , interviewQuestionById  } from '@/action/SkillsQuestionAction';
import constant from 'constant'
import { getStorage } from 'utils';
import moment from "moment";
import Pic from "src/assets/images/profilePic/secondary.jpg"
                        ...
                        <div className="row">
                                  ...
                                  <div >
                                    <div  style={{display:'flex',flexDirection:'row'}}>
                                        <div className='img' style={{borderRadius:'25px',paddingRight:'2em'}}>
                                            <Image src={item.PROFILE_IMAGE?item.PROFILE_IMAGE :Pic} alt="img description" style={{height:'5em',width:'5em'}} />
                                        </div>
                            ...
                            <div className="col-12 col-sm-12 col-md-4 col-lg-4">
                                ...
                                <div className='questions-top-designations-Box'>
                                    ...
                                    <Link href={constant.component.interviewQuestionBySkills.url}><div className='more-item-box'><a className='rg-onHoverButton'>Explore more skills</a> </div></Link>
                                </div> 
                        ...
                        {PREMIUM_COMPANIES && PREMIUM_COMPANIES.length>0 && PREMIUM_COMPANIES.map((item)=>(
                            <div className='SimilarCompanies-item'>
                              <div className='SimilarCompanies-img'>
                                ...
                                { item.COMPANY_LOGO && item.COMPANY_LOGO != 'NA'?
                                    <Image src={`${process.env.NEXT_PUBLIC_BASE_URL}/company/logo/${item.COMPANY_LOGO}`} alt={item.COMPANY_NAME} width={100} height={80}/>:
                                  <h3> { item.COMPANY_NAME.split(' ')[0]}</h3>
                                }
                                </div>
