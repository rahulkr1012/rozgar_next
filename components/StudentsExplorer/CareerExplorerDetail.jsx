...
import ModalWindows from '../common/ModalWindow/ModalWindow'
      ...
      <main id="rg-main" className="rg-main rg-haslayout pt-0">
          ...
          return (
            <>
              <section className='studetsexplorer  -type-5' style={{
                backgroundImage: `url(${!item.ENTITY_MAIN_IMAGE ? studentBanner.src : (`${process.env.NEXT_PUBLIC_BASE_URL}/college/logo/${item.ENTITY_MAIN_IMAGE}`)})`
              }}>
                      ...
                      <div className='contentlistarea'>
                        <div className='onecolldetailbox'>
                          <div className='onecollogo'>
                            <img className='col-logo-md' src={!item.ENTITY_LOGO ? collegeIcon : (` ${process.env.NEXT_PUBLIC_BASE_URL}/college/logo/${item.ENTITY_LOGO}`)} />
                      ...
                      <div className='col-md-4'>
                        <div className='college-btn-apply'>
                          ...
                          <div className='btn-askaquestion-box'>
                           ...
                           <Image   width={500}
                              height={500} src={university} style={unismallpic} />
          ...
          <div className='container pt-4'>
            <div className='row'>
              <div className='col-md-12 text-center'>
                <a target='_blank' href="https://www.mounttalent.com/">

                <Image 
                  width={1000}
                  height={1000} className='img-responsive width-100' src={addFbanner} /></a>
              </div>
            </div>
          </div>
        </section>
                ...
                <section className='subcoursesarea'>
                  <div className='container'>
                    ...
                    <div className='row row-display'>
                      ...
                      <div 
                      style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center', fontWeight: 'lighter', fontSize: '1.2em' }}>
                       <Image
                          //  sizes="(max-width: 500) auto"
                          height={500}
                          width={500}
                          src={CourseSummary}  />
        ...
        <section>
          <div className='container pb-4'>
            <div className='row'>
              <div className='col-md-12 text-center'>
                <a target='_blank' href="https://www.mounttalent.com/"><Image  
                
                width={1000}
      height={1000} className='img-responsive width-100' src={addscollege} /></a>
              </div>
            </div>
          </div>
        </section>
                                      ...
                                      <div class="ptf-advantage-box">
                                        <div class="ptf-advantage-box__content">
                                          <div class="ptf-advantage-box__image">
                                            <Image   
                                            width={1000}
      height={1000} src={item.FACILITY_ICON} alt={item.FACILITY_TITLE} loading="lazy" /></div>
        ...
        <section>
          <div className='container pt-4'>
            <div className='row'>
              <div className='col-md-12 text-center'>
                <a target='_blank' href="https://www.mounttalent.com/"><Image   width={1000}
      height={1000} className='img-responsive width-100' src={addbanner} /></a>
              </div>
            </div>
          </div>
        </section>
                            ...
                            <div className='collegeimg'>
                              <div className='h-100'>
                                <div className='imgarea'>
                                  <Image className='imgmain' src={item.ENTITY_MAIN_IMAGE ? (` ${process.env.NEXT_PUBLIC_BASE_URL}/college/logo/${item.ENTITY_MAIN_IMAGE}`) : collegeImage}   width={500}
      height={200} />
                  ...
                  <div class="form-group logotextbg">
                    ...
                    <div className='d-flex pb-2'>
                      <div className='Unlogo'>
                        <Image   width={500}
      height={500} className='col-logo' src={collegeIcon} />
                      </div>
