...
import itaUniversity1 from 'src/assets/images/ita-university1.jpg'
import itaUniversity2 from 'src/assets/images/ita-university2.jpg'
import itaUniversity3 from 'src/assets/images/ita-university3.jpg'
import itaUniversity4 from 'src/assets/images/ita-university4.jpg'
import itaUniversity5 from 'src/assets/images/ita-university5.jpg'
import itaUniversity6 from 'src/assets/images/ita-university6.jpg'
import itaUniversity7 from 'src/assets/images/ita-university7.jpg'
import itaUniversity8 from 'src/assets/images/ita-university8.jpg'
import itaUniversity9 from 'src/assets/images/ita-university9.jpg'
import itaUniversity10 from 'src/assets/images/ita-university10.jpg'
                            ...
                            <div className='colleges-countary-box'>
                                ...
                                <div className='Marquee-countary'>
                                    <div className='Marquee-content'>
                                        <div className='Marquee-tag'><Image src={itaUniversity1} alt='Image' /></div>
                                        <div className='Marquee-tag'><Image src={itaUniversity2} alt='Image' /></div>
                                        <div className='Marquee-tag'><Image src={itaUniversity3} alt='Image' /></div>
                                        <div className='Marquee-tag'><Image src={itaUniversity4} alt='Image' /></div>
                                        <div className='Marquee-tag'><Image src={itaUniversity5} alt='Image' /></div>
                                        <div className='Marquee-tag'><Image src={itaUniversity6} alt='Image' /></div>
                                        <div className='Marquee-tag'><Image src={itaUniversity7} alt='Image' /></div>
                                        <div className='Marquee-tag'><Image src={itaUniversity8} alt='Image' /></div>
                                        <div className='Marquee-tag'><Image src={itaUniversity9} alt='Image' /></div>
                                        <div className='Marquee-tag'><Image src={itaUniversity10} alt='Image' /></div>
