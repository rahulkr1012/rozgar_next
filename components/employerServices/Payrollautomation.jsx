...
import PayrollAccuracy from '../../src/assets/images/PR.png'
import ReducedPayrollCost from '../../src/assets/images/SC2.png'
import ComplianceAndPayrollManagement from '../../src/assets/images/taxpay.png'
                                        ...
                                        <div className='usp-top-box'>
                                            ...
                                            <div className='usp-main-item'>
                                                <div className='usp-item-box'>
                                                    <div className='icon-img'><Image src={PayrollAccuracy} /></div>
                                                ...
                                                <div className='usp-item-box'>
                                                    <div className='icon-img'><Image src={ReducedPayrollCost} /></div>
                                                ...
                                                <div className='usp-item-box'>
                                                    <div className='icon-img'><Image src={ComplianceAndPayrollManagement} /></div>
