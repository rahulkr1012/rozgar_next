 ...
 class Signin extends Component {
	constructor(props) {
		...
		this.state = {
			...
			showModal: false,
			passwordShow: false,
			addUpdate:getCookie(constant.keys.addAndUpdate) ? JSON.parse(getCookie(constant.keys.addAndUpdate)) : null,
			saveJobId:getCookie(constant.keys.saveJobId) ? JSON.parse(getCookie(constant.keys.saveJobId)) : null,
			jobStatus: false,
		}
	}
									...
									<div class="fxt-content pt-2 pb-5">
										...
										<div class="fxt-form aplay-fxt-form-bx">
											<form onSubmit={(e) => { this.onSubmit(e) }} method="POST">
												...
												<div class="form-group">
													<div class="fxt-checkbox-area">
														...
														<Link href={constant.component.forgotPassword.url} class="switcher-text">Forgot Password</Link>
													</div>
												</div>
												<div class="form-group">
											...
											<ul class="fxt-socials pl-4">
												...
												<li className='linkedIn'><LinkedInPage/></li>

												{/* <li class="fxt-facebook">
													<div class="fxt-transformY-50 fxt-transition-delay-5">
														<Link href='' title="Facebook" className='regfacebook'>
										...
										<div class="fxt-footer">
											<p style={{paddingLeft: '10px'}}>Don't have an account?<Link href={{
												pathname:`/register`,
												query:{JOB_ID:this.state.addUpdate?.JOB_ID, SAVE_JOB_ID:this.state.saveJobId?.JOB_ID},
												}}
												as={`/register`}
