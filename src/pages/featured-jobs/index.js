...
import { getFeaturedJobs, getSaveJobList, SaveJobs } from '@/action/CandidateAction'
        ...
        return (
            <React.Fragment>
                <Head>
                    ...
                    <title title={"Featured Jobs | Rozgar.com"} >{"Featured Jobs | Rozgar.com"}</title>
                    <meta name="HandheldFriendly" content="True" />
                    <meta name="description" content={"Featured Jobs " + constant.metaDescription} />
                    ...
                    <meta property="og:title" content={"Featured Jobs "} />
                    <meta property="og:description" content={"Featured Jobs " + constant.metaDescription} />
                    <meta property="og:url" content={"https://rozgar.com/featured-jobs"} />
                    <meta property="og:image" content="https://rozgarlogo.s3.ap-south-1.amazonaws.com/download.png" />
                    <meta property="og:image:width" content="4000" />
                    <meta property="og:image:height" content="6000" />

                    <meta name="twitter:card" content="summary_large_image" />
                    <meta name="twitter:title" content={"Featured Jobs | Rozgar.com"} />
                    <meta name="twitter:description" content={"Featured Jobs " + constant.metaDescription} />
                    <meta name="twitter:url" content={"https://rozgar.com/featured-jobs"} />
                    ...
                    <link rel="canonical" href={"https://rozgar.com/featured-jobs"} />
                </Head>
                                                ...
                                                <div className='row'>
                                                    <div className='col-md-8'>
                                                        ...
                                                        {this.state.list && this.state.list == 0 && <div className="rg-featurejob text-danger pt-20" style={{ textAlign: 'center' }}>
                                                            ...
                                                            <h6><Link href={constant.component.editProfile.url} style={{ color: '#EE6828' }}>Click here</Link> to complete your profile and start getting recommended jobs</h6>
                                                            ...
                                                            <Link href={constant.component.login.url} class="rg-btn rg-active btn-primary mb-20" id="showtoast"><span className='text-white'>Complete your profile</span></Link>
                                                                            ...
                                                                            <div className="rg-featurejobholder">
                                                                                ...
                                                                                <div className="rg-featurejob">
                                                                                    <figure className="rg-companyimg" >
                                                                                        ...
                                                                                        {data.COMPANY_LOGO === 'NA' ? <h6 style={{ marginBottom: "0" }}>{data.COMPANY_NAME.split(' ').length === 1 ? data.COMPANY_NAME.slice(0, 1) : data.COMPANY_NAME.split(' ').map((i) => i.substring(0, 1)).join('').slice(0, 3)}</h6> : <img src={`${process.env.NEXT_PUBLIC_BASE_URL}/company/logo/${data.COMPANY_LOGO}`} alt={data.COMPANY_NAME} />}
                                                                                    </figure>
                                                                                    ...
                                                                                    <div className="rg-companycontent">
                                                                                        ...
                                                                                        <div className="rg-companyname">
                                                                                            ...
                                                                                            <div className="companyreviewbox">
                                                                                                ...
                                                                                                <a href="#"><span className="reviewlink">({data.REVIEW_COUNT ? data.REVIEW_COUNT : 0} Reviews)</span></a>
                                                                                            </div>
                                                                                        </div>
                                                    ...
                                                    <div className='col-md-4'>
                                                        <div className='savejobs-aside'>
                                                            {showLoader ? <SideLoader /> :
                                                                <ul>
                                                                    <li ><Link href="/recommended-jobs"><i class="ti-bookmark"></i><span style={{ color: '#000' }}>Recommended Job</span> </Link></li>
                                                                    <li><Link href="/premium-jobs"><i class="lnr lnr-bullhorn"></i><span style={{ color: '#000' }}>Premium Job</span> </Link></li>
                                                                    <li><Link href="/interview-questions"><i className="ti-crown"></i><span style={{ color: '#000' }}>Interview Question</span> </Link></li>
                                                                    <li><Link href="/top-companies"><i class="lnr lnr-apartment"></i> <span style={{ color: '#000' }}>Top Companies</span> </Link></li>
                                                                    <li><Link href="/fresher-jobs"><i className="lnr lnr-graduation-hat"></i><span style={{ color: '#000' }}>Freshers Jobs</span> </Link></li>
                                                                    ...
                                                                    {/* <li><Link href={constant.component.internationalWorkVisas.url}><i class="fa fa-plane"></i><span style={{ color: '#000' }}>International Jobs</span> </Link></li> */}
                                                                    <li><Link href="/rewards"><Image className='imgrewards' src={reward} /><span style={{ color: '#000', marginLeft: "10px" }}>Rewards</span> </Link></li>
