...
import { IQDesignationList } from '@/action/CompanyQuestionAction'
...
const Designation = dynamic( () => import('../../../../components/InterviewQuestions/Designation'), { loading:()=><Loader /> ,   ssr: false });
...
export default function index(props) {
    ...
    return (
        <React.Fragment>
         ...
         <title> Interview Questions by Designation - Rozgar.com </title>
         ...
         <meta property="og:title" content={"Interview Questions by Designation - Rozgar.com"} />
         ...
         <meta name="twitter:title" content={"Interview Questions by Designation - Rozgar.com"} />
                    ...
                    <div className={router.pathname === constant.component.interviewQuestion.url ? 'rozgar-browseJobs' : 'rozgar-profile-main-content'}>
                        <div className='container'>
                            <div className='row'>
                                ...
                                {router.pathname === constant.component.interviewQuestionByDesignation.url && !DesignationList.length && <Loader />}
                                    {
