...
import { IQITSkillList, IQNonITSkillList } from '@/action/CompanyQuestionAction'
...
const Skills = dynamic( () => import('components/InterviewQuestions/Skills'), { loading:()=><Loader /> ,   ssr: false });
...
export default function index(props) {
    ...
    const [NON_IT_SKILL_LIST, setNON_IT_SKILL_LIST] = useState(0)
    ...
    return (
        <React.Fragment>
         ...
         <Head>  
         <title> Interview Questions by Skills - Rozgar.com </title>
         ...
         <meta property="og:title" content={"Interview Questions by Skills - Rozgar.com"} />
         ...
         <meta name="twitter:title" content={"Interview Questions by Skills - Rozgar.com"} />
                    ...
                    <div className={router.pathname === constant.component.interviewQuestion.url ? 'rozgar-browseJobs' : 'rozgar-profile-main-content'}>
                        <div className='container'>
                            <div className='row'>
                                ...
                                {router.pathname === constant.component.interviewQuestionBySkills.url && !IT_SKILL_LIST.length && <Loader />}
                                    {
                                        router.pathname === constant.component.interviewQuestionBySkills.url && IT_SKILL_LIST.length > 0 &&
