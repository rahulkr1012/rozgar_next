...
export default class index extends Component {
    ...
    componentDidMount() {
        this.setState({ aboutJobName: 'MostLiked Video JD Jobs' })
        document.title = constant.title.MostLikedVideoJdJob
        window.scrollTo(0, 0)
  ...
  render() {
    ...
    return (
     <React.Fragment>
        <Head>
        <title data-react-helmet="true">Apply For Most Liked Video JD Jobs in India- Rozgar.com </title>
                <meta data-react-helmet="true" name="desccription" content="MY OTHER PAGE CONTENT" /> 

 
                <meta name="HandheldFriendly" content="True" />
                <meta name="description" content={"Apply for the most liked video JD jobs in different cities of India. Rozgar.com provides best video JD jobs for the employees who are looking for jobs." } />
                <meta name="referrer" content="no-referrer-when-downgrade" />
                <meta property="og:site_name" content="Rozgar.com" />
                <meta name="viewport" content="width=device-width, initial-scale=1"/>
                <meta property="og:title"content={"Apply For Most Liked Video JD Jobs in India- Rozgar.com"} />
                <meta property="og:description" content={  "Apply for the most liked video JD jobs in different cities of India. Rozgar.com provides best video JD jobs for the employees who are looking for jobs."} />
                <meta property="og:image:width" content="4000" />
                <meta property="og:image:height" content="6000" />
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content={"Apply For Most Liked Video JD Jobs in India- Rozgar.com"} />
                <meta name="twitter:description"  content={  "Apply for the most liked video JD jobs in different cities of India. Rozgar.com provides best video JD jobs for the employees who are looking for jobs."} />
                <meta name="twitter:label1" content="Written by" />
                <meta name="twitter:data1" content="Smita Nag" />
                <meta name="twitter:label2" content="Filed under" />
                <meta name="twitter:data2" content="Career Advice, Career Insights" />
                <meta name="twitter:site" content="@rozgar_india" />
                <link rel="canonical" href={"https://rozgar.com/most-liked-video-jd-jobs"} />
