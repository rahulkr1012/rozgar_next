...
import { getResumeData } from '@/actions/CandidateAction';
...
// let ResumeTemplate1 =  dynamic(import('components/ResumeTemplate1') ,
//  {
//     ssr:false ,
//     loading:()=><Loading /> 
//  }) ;
...
import { getCourseSpeczListForJobs, getEduQualificationTypeListsForJobs } from '@/action/CandidateAction';


// const ResumeTemplate1 = dynamic(import('components/ResumeTemplate1'), {
//   ssr: false,
//   loading: () => <Loader />
// });


class resumeTemplate1 extends Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(resumeTemplate1))
