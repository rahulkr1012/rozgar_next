...
// const ResumeTemplate2  =dynamic(import('components/ResumeTemplate2') , {
//     ssr:false ,
//     loading:()=><Loader />  
// } ) ;
 ...
 class resumeTemplate2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ud: this.props.ud,
...
let mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(withRouter(resumeTemplate2))
