...
import { getCourseSpeczListForJobs, getEduQualificationTypeListsForJobs, getResumeData } from '@/action/CandidateAction';
...
import ResumeTemplateViewThree from 'components/ResumeTemplateView03' 
// let ResumeTemplateViewThree = dynamic(import( 'components/ResumeTemplateView03') , {
//     ssr:false ,
//     loading:()=> <Loader />
// })
 
class resumeTemplateView03 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ud: this.props.ud,
...
let mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(withRouter(resumeTemplateView03))
