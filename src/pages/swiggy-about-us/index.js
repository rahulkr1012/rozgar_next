...
let SwiggyAbout = dynamic(()=>import('components/Companies/Swiggy/SwiggyAboutUs') , { ssr:false } ) 
...
export default withRouter( class SwiggyAboutUs extends Component {
      ...
      <React.Fragment>
                 ...
                 <title title={ capFirstLetterInSentence(this.props.router.asPath.replace('/', '').split('/').pop().split('-').join(' ')) + " Overview  – Jobs, Work Culture - Rozgar.com"}>{capFirstLetterInSentence(this.props.router.asPath.replace('/', '').split('/').pop().split('-').join(' ')) + " Overview  – Jobs, Work Culture - Rozgar.com"}</title>
                   ...
                   <link rel="canonical"  href={this.props.router.asPath} />
                    ...
                    <meta property="og:description" content={ capFirstLetterInSentence(this.props.router.asPath.replace('/','').split('/').pop().split('-').join(' ')) + " )verview – Know more about job opportunities, employee feedback and Ratings, work culture, immediate hirings etc at Rozgar.com."} />
