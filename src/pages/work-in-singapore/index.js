...
const WorkinSingapore = dynamic(() => import('components/InterNationalWorkVisa/WorkinSingapore'), { loading: () => <Loader />, ssr: true });
export default function index(props) {
  const { ud } = props;
  return (
   <React.Fragment>
    <Head>
  <title>Work in Singapore - Rozgar.com</title>
  <link
    rel="canonical"
    href="https://rozgar.com/work-in-singapore"
    data-react-helmet="true"
  />
  <meta name="HandheldFriendly" content="True" data-react-helmet="true" />
  <meta
    name="Keywords"
    content="Work In Singapore, Jobs in India, Jobs in Noida, Search & Apply Job"
    data-react-helmet="true"
  />
  <meta
    name="description"
    content="Work In Singapore Singapore, one of the world’s most expensive cities, is an economic hub, with energetic city culture that offers an array of opportunities to people who land here to access work opportunities."
    data-react-helmet="true"
  />
  <meta
    name="referrer"
  ...
  <meta
    property="og:url"
    content="https://rozgar.com/work-in-singapore"
    data-react-helmet="true"
  />
  <meta
    property="og:image"
